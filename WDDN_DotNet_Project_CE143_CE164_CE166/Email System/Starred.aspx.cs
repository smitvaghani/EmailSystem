...
namespace Email_System
{
    public partial class Starred : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            title.Text = "Starred - " + email;
            getMail();
        }
        public void getMail()
        {
            IQueryable<Mail> mails = appDbContext.Mails.Where(m => ((m.ReceiverUserModelId == userId || m.SenderUserModelId==userId) && m.starred==true));
        ...
        protected void gridView_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                else
                {
                    ...
                    linkButton.CssClass = "fa fa-envelope fa-lg text-decoration-none";
